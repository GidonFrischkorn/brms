...
```
    ...
    sd(tarsus_Intercept)                     0.48      0.05     0.40     0.59 1.00      996
    sd(back_Intercept)                       0.25      0.07     0.10     0.39 1.00      393
    cor(tarsus_Intercept,back_Intercept)    -0.51      0.21    -0.91    -0.08 1.00      773
                                         Tail_ESS
    sd(tarsus_Intercept)                     1241
    sd(back_Intercept)                        583
    cor(tarsus_Intercept,back_Intercept)      980

    ~fosternest (Number of levels: 104) 
                                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    sd(tarsus_Intercept)                     0.27      0.05     0.17     0.38 1.00      820
    sd(back_Intercept)                       0.35      0.06     0.23     0.46 1.00      621
    cor(tarsus_Intercept,back_Intercept)     0.67      0.21     0.20     0.98 1.00      384
                                         Tail_ESS
    sd(tarsus_Intercept)                     1256
    sd(back_Intercept)                       1234
    cor(tarsus_Intercept,back_Intercept)      659

    Regression Coefficients:
                     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    tarsus_Intercept    -0.40      0.07    -0.54    -0.26 1.00     1711     1580
    back_Intercept      -0.01      0.07    -0.14     0.12 1.00     2707     1609
    tarsus_sexMale       0.77      0.06     0.66     0.88 1.00     4048     1436
    tarsus_sexUNK        0.23      0.13    -0.02     0.47 1.00     3590     1633
    tarsus_hatchdate    -0.04      0.06    -0.15     0.07 1.00     1603     1192
    back_sexMale         0.01      0.07    -0.12     0.14 1.00     3315     1444
    back_sexUNK          0.15      0.15    -0.14     0.44 1.00     4470     1299
    back_hatchdate      -0.09      0.05    -0.19     0.01 1.00     2783     1492

    Further Distributional Parameters:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma_tarsus     0.76      0.02     0.72     0.80 1.00     2694     1321
    sigma_back       0.90      0.02     0.85     0.95 1.00     2375     1384

    Residual Correlations: 
                        Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    rescor(tarsus,back)    -0.05      0.04    -0.13     0.02 1.00     3297     1445
...
```
    ...
    R2tarsus 0.4331936 0.02669305 0.3780412 0.4822348
    R2back   0.1995451 0.03003342 0.1396641 0.2587083
...
```
    ...
    ~dam (Number of levels: 106) 
                                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    sd(tarsus_Intercept)                     0.48      0.05     0.38     0.59 1.01      759
    sd(back_Intercept)                       0.24      0.07     0.08     0.38 1.00      274
    cor(tarsus_Intercept,back_Intercept)    -0.51      0.22    -0.92    -0.07 1.00      522
                                         Tail_ESS
    sd(tarsus_Intercept)                     1072
    sd(back_Intercept)                        595
    cor(tarsus_Intercept,back_Intercept)      703

    ~fosternest (Number of levels: 104) 
                                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    sd(tarsus_Intercept)                     0.26      0.05     0.16     0.37 1.00      689
    sd(back_Intercept)                       0.35      0.06     0.24     0.47 1.01      520
    cor(tarsus_Intercept,back_Intercept)     0.68      0.21     0.22     0.98 1.01      229
                                         Tail_ESS
    sd(tarsus_Intercept)                      802
    sd(back_Intercept)                       1033
    cor(tarsus_Intercept,back_Intercept)      508

    Regression Coefficients:
                     Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    tarsus_Intercept    -0.41      0.07    -0.54    -0.27 1.00     1337     1527
    back_Intercept      -0.00      0.05    -0.11     0.10 1.00     1875     1697
    tarsus_sexMale       0.77      0.06     0.66     0.89 1.00     3127     1256
    tarsus_sexUNK        0.22      0.13    -0.04     0.48 1.00     3689     1424
    back_hatchdate      -0.08      0.05    -0.19     0.02 1.00     2065     1700

    Further Distributional Parameters:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma_tarsus     0.76      0.02     0.72     0.80 1.00     2224     1441
    sigma_back       0.90      0.02     0.85     0.95 1.00     2455     1525

    Residual Correlations: 
                        Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    rescor(tarsus,back)    -0.05      0.04    -0.13     0.02 1.00     2713     1535
...
```
    ...
    Model comparisons:
     model elpd_diff se_diff p_worse       diag_diff      diag_elpd
      ...
      fit1      -0.6     1.3    0.67 |elpd_diff| < 4 3 k_psis > 0.7
...
```
    ...
    Smoothing Spline Hyperparameters:
                           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sds(back_shatchdate_1)     1.95      0.99     0.24     4.20 1.01      353      195

    Multilevel Hyperparameters:
    ~dam (Number of levels: 106) 
                                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    sd(tarsus_Intercept)                     0.48      0.05     0.38     0.58 1.00      547
    sd(back_Intercept)                       0.25      0.07     0.10     0.38 1.02      238
    cor(tarsus_Intercept,back_Intercept)    -0.50      0.23    -0.92    -0.06 1.00      525
                                         Tail_ESS
    sd(tarsus_Intercept)                     1117
    sd(back_Intercept)                        397
    cor(tarsus_Intercept,back_Intercept)      583

    ~fosternest (Number of levels: 104) 
                                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
    sd(tarsus_Intercept)                     0.26      0.05     0.15     0.37 1.01      388
    sd(back_Intercept)                       0.31      0.06     0.19     0.42 1.00      344
    cor(tarsus_Intercept,back_Intercept)     0.65      0.21     0.19     0.98 1.01      303
                                         Tail_ESS
    sd(tarsus_Intercept)                      754
    sd(back_Intercept)                        769
    cor(tarsus_Intercept,back_Intercept)      396

    Regression Coefficients:
                         Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    tarsus_Intercept        -0.41      0.07    -0.55    -0.28 1.00      889     1191
    back_Intercept           0.00      0.05    -0.10     0.10 1.00     1490     1347
    tarsus_sexMale           0.77      0.06     0.66     0.88 1.00     2979     1663
    tarsus_sexUNK            0.22      0.12    -0.01     0.44 1.00     2436     1578
    sigma_tarsus_sexFem     -0.30      0.04    -0.38    -0.22 1.00     2640     1182
    sigma_tarsus_sexMale    -0.25      0.04    -0.33    -0.16 1.00     2563     1664
    sigma_tarsus_sexUNK     -0.39      0.13    -0.64    -0.12 1.00     1830     1451
    back_shatchdate_1       -0.29      2.97    -5.73     6.11 1.00      955     1162

    Further Distributional Parameters:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma_back       0.90      0.02     0.85     0.95 1.00     2049     1381
    alpha_tarsus    -1.23      0.42    -1.87    -0.03 1.00     1395      795
