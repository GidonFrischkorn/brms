...
```
    ...
    ~phylo (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)    16.44      1.84    12.99    20.24 1.00     1481     2582

    ~species (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     4.96      0.84     3.24     6.60 1.00     1075     1392

    Regression Coefficients:
                 Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept       36.23      7.80    20.83    51.32 1.00     4370     3999
    spec_mean_cf     5.10      0.10     4.91     5.30 1.00     9118     4554

    Further Distributional Parameters:
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     8.11      0.20     7.72     8.52 1.00     4644     4543
...
```
    ...
    Hypothesis Tests for class :
                    Hypothesis Estimate Est.Error CI.Lower CI.Upper Evid.Ratio Post.Prob Star
    1 (sd_phylo__Interc... = 0     0.74      0.05     0.62     0.83          0         0    *
    ---
    'CI': 90%-CI for one-sided and 95%-CI for two-sided hypotheses.
    '*': For one-sided hypotheses, the posterior probability exceeds 95%;
    for two-sided hypotheses, the value tested against lies outside the 95%-CI.
...
```
    ...
    ~phylo (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)    16.37      1.90    12.84    20.29 1.00     1295     2913

    ~species (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     5.00      0.85     3.32     6.63 1.00     1117     1753

    Regression Coefficients:
                   Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept         36.26      7.73    21.08    51.60 1.00     3985     3787
    spec_mean_cf       5.10      0.10     4.89     5.30 1.00     7630     4366
    within_spec_cf    -0.06      0.19    -0.42     0.30 1.00    10341     4118

    Further Distributional Parameters:
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     8.11      0.20     7.73     8.52 1.00     5242     4079
...
```
    ...
    ~obs (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     0.05      0.03     0.00     0.10 1.00      647      888

    ~phylo (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     0.07      0.04     0.00     0.15 1.00      631     1496

    Regression Coefficients:
              Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept     0.16      0.04     0.07     0.24 1.00     3135     2258
...
```
    ...
    ~obs (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     0.18      0.08     0.02     0.35 1.01      492      976

    ~phylo (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     0.18      0.10     0.02     0.41 1.01      786     1411

    Regression Coefficients:
              Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept    -2.08      0.20    -2.49    -1.69 1.00     3147     2422
    cofactor      0.25      0.01     0.23     0.27 1.00     4112     2522
...
```
    ...
    ~phylo (Number of levels: 200) 
                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sd(Intercept)     0.67      0.48     0.04     1.85 1.00     1074     2045

    Regression Coefficients:
              Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    Intercept    -3.07      0.64    -4.34    -1.85 1.00     4852     2211
    cofactor      0.68      0.04     0.59     0.76 1.00     8395     2614

    Further Distributional Parameters:
          Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    sigma     3.44      0.19     3.09     3.84 1.00     6115     2678
...
```
    ...
    Model comparisons:
     ...
     model_normal    -188.0    18.1    1.00           1 k_psis > 0.7
