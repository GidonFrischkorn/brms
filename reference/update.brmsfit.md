...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.582 seconds (Warm-up)
#> Chain 1:                3.838 seconds (Sampling)
#> Chain 1:                6.42 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2:                4.298 seconds (Sampling)
#> Chain 2:                4.754 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3:                3.224 seconds (Sampling)
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.307 seconds (Warm-up)
#> Chain 4:                4.131 seconds (Sampling)
#> Chain 4:                6.438 seconds (Total)
#> Chain 4: 
...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 1.229 seconds (Warm-up)
#> Chain 1:                0.496 seconds (Sampling)
#> Chain 1:                1.725 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.256 seconds (Warm-up)
#> Chain 3:                0.497 seconds (Sampling)
#> Chain 3:                1.753 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
