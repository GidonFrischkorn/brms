...
#> Chain 1:                1.493 seconds (Sampling)
#> Chain 1:                3.62 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 2.087 seconds (Warm-up)
#> Chain 2:                1.397 seconds (Sampling)
#> Chain 2:                3.484 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 2.108 seconds (Warm-up)
#> Chain 3:                1.456 seconds (Sampling)
#> Chain 3:                3.564 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.056 seconds (Warm-up)
#> Chain 4:                1.433 seconds (Sampling)
#> Chain 4:                3.489 seconds (Total)
#> Chain 4: 
summary(fit2)
#>  Family: poisson 
#>   Links: mu = log 
