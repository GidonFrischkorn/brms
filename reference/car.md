...
#> Chain 1: 
#> Chain 1: Gradient evaluation took 0.002258 seconds
#> Chain 1: 1000 transitions using 10 leapfrog steps per transition would take 22.58 seconds.
...
#> Chain 1:                0.893 seconds (Sampling)
...
#> Chain 2: 
#> Chain 2:  Elapsed Time: 0.772 seconds (Warm-up)
...
#> Chain 3: 
#> Chain 3:  Elapsed Time: 0.657 seconds (Warm-up)
...
#> Chain 4: 
#> Chain 4:  Elapsed Time: 0.708 seconds (Warm-up)
#> Chain 4:                0.564 seconds (Sampling)
#> Chain 4:                1.272 seconds (Total)
#> Chain 4: 
