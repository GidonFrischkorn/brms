...
#> Chain 2: 
#> Chain 2:  Elapsed Time: 1.444 seconds (Warm-up)
#> Chain 2:                1.377 seconds (Sampling)
#> Chain 2:                2.821 seconds (Total)
#> Chain 2: 
#> 
...
#> Chain 4:                1.441 seconds (Sampling)
#> Chain 4:                2.984 seconds (Total)
#> Chain 4: 
summary(fit1)
#>  Family: sratio 
#>   Links: mu = logit 
...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 5.748 seconds (Warm-up)
#> Chain 1:                3.99 seconds (Sampling)
#> Chain 1:                9.738 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 5.747 seconds (Warm-up)
#> Chain 2:                4.02 seconds (Sampling)
#> Chain 2:                9.767 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: 
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 5.728 seconds (Warm-up)
#> Chain 3:                4.018 seconds (Sampling)
#> Chain 3:                9.746 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: 
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 5.955 seconds (Warm-up)
#> Chain 4:                3.997 seconds (Sampling)
#> Chain 4:                9.952 seconds (Total)
#> Chain 4: 
summary(fit2)
#>  Family: cumulative 
#>   Links: mu = logit 
