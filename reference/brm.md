...
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.045 seconds (Warm-up)
#> Chain 1:                1.434 seconds (Sampling)
#> Chain 1:                3.479 seconds (Total)
#> Chain 1: 
#> 
...
#> Chain 3: 
#> Chain 3:  Elapsed Time: 1.77 seconds (Warm-up)
#> Chain 3:                1.459 seconds (Sampling)
#> Chain 3:                3.229 seconds (Total)
#> Chain 3: 
#> 
...
#> Chain 4: 
#> Chain 4:  Elapsed Time: 1.983 seconds (Warm-up)
#> Chain 4:                1.582 seconds (Sampling)
#> Chain 4:                3.565 seconds (Total)
#> Chain 4: 
...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 2.687 seconds (Warm-up)
#> Chain 1:                2.594 seconds (Sampling)
#> Chain 1:                5.281 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
#> Chain 2: 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 2.79 seconds (Warm-up)
#> Chain 2:                2.418 seconds (Sampling)
#> Chain 2:                5.208 seconds (Total)
#> Chain 2: 
summary(fit2)
#>  Family: sratio 
#>   Links: mu = logit 
...
#> Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 1: 
#> Chain 1:  Elapsed Time: 0.919 seconds (Warm-up)
#> Chain 1:                0.37 seconds (Sampling)
#> Chain 1:                1.289 seconds (Total)
#> Chain 1: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 2).
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 0.939 seconds (Warm-up)
#> Chain 3:                0.339 seconds (Sampling)
#> Chain 3:                1.278 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 11.487 seconds (Warm-up)
#> Chain 4:                11.825 seconds (Sampling)
#> Chain 4:                23.312 seconds (Total)
#> Chain 4: 
...
#> Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 2: 
#> Chain 2:  Elapsed Time: 2.362 seconds (Warm-up)
#> Chain 2:                1.211 seconds (Sampling)
#> Chain 2:                3.573 seconds (Total)
#> Chain 2: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 3).
#> Chain 3: Rejecting initial value:
...
#> Chain 3: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 3: 
#> Chain 3:  Elapsed Time: 2.363 seconds (Warm-up)
#> Chain 3:                1.24 seconds (Sampling)
#> Chain 3:                3.603 seconds (Total)
#> Chain 3: 
#> 
#> SAMPLING FOR MODEL 'anon_model' NOW (CHAIN 4).
#> Chain 4: Rejecting initial value:
...
#> Chain 4: Iteration: 2000 / 2000 [100%]  (Sampling)
#> Chain 4: 
#> Chain 4:  Elapsed Time: 2.333 seconds (Warm-up)
#> Chain 4:                1.089 seconds (Sampling)
#> Chain 4:                3.422 seconds (Total)
#> Chain 4: 
summary(fit5)
#>  Family: gaussian 
#>   Links: mu = identity 
